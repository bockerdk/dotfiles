local colorscheme = require('bocker-colorscheme.colorscheme')
local config = require('bocker-colorscheme.config')
local utils = require('bocker-colorscheme.utils')
local M = {}
...
local function set_groups()
    ...
    local groups = {
        ...
        Comment = {
            ...
            italic = config.options.italics.comments or false,
        },

        Constant = { fg = colorscheme.syntaxError },
        String = {
            fg = colorscheme.stringText,
            italic = config.options.italics.strings or false,
        },
        ...
        Function = { fg = colorscheme.syntaxKeyword, bg = colorscheme.bg },
        ...
        Keyword = { link = 'Statement', italic = config.options.italics.keywords or false },
        ...
        ['@function'] = {
            link = 'Function',
            italic = config.options.italics.functions or false,
        },
        ...
        ['@variable'] = {
            fg = colorscheme.syntaxFunction,
            italic = config.options.italics.variables or false,
        },
    ...
    groups = vim.tbl_extend(
        'force',
        groups,
        type(config.options.overrides) == 'function' and config.options.overrides()
        or config.options.overrides
    )
